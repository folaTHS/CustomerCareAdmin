...
const Total_Card = (props) => {
  ...
  return (
    <div id={Style.Total_Card_mainDiv} onClick={onClick}>
      <div
        id={Style.Total_Card_Wrapper}
        style={{
          backgroundColor: isBlack ? "#0B438D" : "#FFFFFF",
          cursor: "pointer",
        }}
      >
        <div id={Style.Total_Card_firstLine_Div}>
          <div id={Style.Total_Card_firstLine_ImgDiv}>
            <img src={image1} alt="" />
            <div
              id={Style.Total_CardText}
              style={{ color: isBlack ? "#FFFFFF" : "#777777" }}
            >
              {text}
            </div>
          </div>
          <div
            id={Style.Total_Card_imgDiv}
            style={{
              borderColor: isBlack ? "#ffffff" : "#0E093C",
              backgroundColor: isBlack ? "#FFFFFF" : "transparent",
            }}
          >
            <Link to={to}>
              <div>{divText}</div>
        ...
        <div id={Style.Total_Card_info_Div}>
          <p
            id={Style.priceText}
            style={{ color: isBlack ? "#FFFFFF" : "#0E093C" }}
          >
            <span>{all}</span> {price}
          </p>
