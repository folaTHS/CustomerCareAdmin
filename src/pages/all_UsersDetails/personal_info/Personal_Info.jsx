  ...
  return (
    <div id={Style.Personal_Info_mainDiv}>
      ...
      <div id={Style.Personal_Info_wrapperDiv}>
        <p id={Style.Onboarded_Text}>
          Onboarded By: <span>John Doe</span>
        </p>
        ...
        <div id={Style.balance_buttonDiv}>
          ...
          <div id={Style.Personal_Info_buttonDiv}>
            ...
            <button onClick={suspendAction}>
              ...
              personalInformation[0].status === "active"
                ? "Suspend Account"
                : "Unsuspend Account"}
            </button>
            ...
            <table>
              ...
              <tbody>
                {personalInformation.map((obj, index) => {
                  let subscribedColor =
                    obj.subscription_type === "blue"
                      ? "#0B438D"
                      : obj.subscription_type === "gold"
                        ? "#D6AB1B"
                        : obj.subscription_type === "black"
                          ? "black"
                          : "";
                  ...
                  return (
                    <tr id={Style.Personal_Info_tr} key={index}>
                        ...
                        <div id={Style.BankDetails_Div}>
                          <div>
                            ...
                            <p className={Style.BankDetails_BoldText}>
                              {obj.bankDetails?.bank_name}
                            </p>
                          </div>
                          <div>
                            <p>Account Number</p>
                            <p className={Style.BankDetails_BoldText}>
                              {obj.bankDetails?.account_number}
                            </p>
                          </div>
                          <div>
                            <p>Account Name</p>
                            <p className={Style.BankDetails_BoldText}>
                              {obj.bankDetails?.account_name}
                            </p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div
                          id={Style.Subscription}
                          style={{ backgroundColor: subscribedColor }}
                        >
        ...
        <div id={Style.Personal_Info_graphReport_Div}>
          ...
          <div id={Style.Personal_Info_Report_mainDiv}>
            <div id={Style.Personal_Info_ReportTextDiv}>
              ...
              <p id={Style.dateText}>
                3rd of October, 2024 <img src={arrow_down} alt="" />
              </p>
            </div>
        ...
        <div>
          <p className={Style.Personal_Info_headerText}>
            Coin Purchase History
          </p>

          <div className={Style.date_inputDiv}>
            <p>
              3rd October, 2024 <img src={arrow_down} alt="" />
            </p>
                        ...
                        {obj.bank && (
                          <div id={Style.BankDetails_Div}>
                            ...
                            <div>
                              <p>Account Number</p>
                              <p className={Style.BankDetails_BoldText}>
                                {obj.paymentType.accNo}
                              </p>
                            </div>
                            <div>
                              <p>Account Name</p>
                              <p className={Style.BankDetails_BoldText}>
                                {obj.paymentType.accName}
                              </p>
                            </div>
                          </div>
                        )}
          ...
          <div id={Style.Personal_Info_tableDiv}>
            <table>
              ...
              <tbody>
                {userDetails.subscriptionHistory.map((item, index) => {
                  console.log(item);
                  let statusColor =
                    item.status === "success"
                      ? "#31C364"
            ...
            {userDetails.subscriptionHistory.length == 0 && (
              <div className={Style.no_queryDiv}>
                <p>No Recent Subscription History</p>
              </div>
            )}
          </div>
        </div>
