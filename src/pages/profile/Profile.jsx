      ...
      <div id={Style.Profile_wrapperDiv}>
        <div id={Style.profile_detailsDiv}>
          <div id={Style.Profile_firstline}>
            ...
            <p id={Style.status}>
              <div id={Style.statusDiv}></div> Online
            </p>
          </div>
        ...
        <div id={Style.settings_Div}>
          <div id={Style.toggleDiv}>
            <button
              ...
              className={
                toggle == 0 ? Style.activeToggle : Style.setting_button
              }
            >
              Account Settings
            </button>
            <button
              ...
              className={
                toggle == 1 ? Style.activeToggle : Style.setting_button
              }
            >
              Customer Care Reps Assist
            </button>
          </div>
          {toggle == 0 ? (
            <div id={Style.setting_wrapperDiv}>
              <div id={Style.setting_img_EditDiv}>
                {imgUrl ? (
                  <img id={Style.profile_img} src={imgUrl} alt="" />
                ) : (
                  <img id={Style.profile_img} src={profile_img} alt="" />
                )}
                ...
                <div onClick={() => editFun()}>
                  {editState ? (
                    <p
                      id={Style.editText}
                      style={{ color: "#FFFFFF", backgroundColor: "#0E093C" }}
                    >
                      <img src={white_edit} alt="" /> Edit
                    </p>
                  ) : (
                    <p id={Style.editText} style={{ color: "#464646" }}>
                ...
                <div id={Style.infoDetails_Div}>
                  ...
                  <div id={Style.settings_informations}>
                    <div>
                      ...
                      <p className={Style.settings_detailsText}>
                        Johndoe@gmail.com
                      </p>
                    </div>
                    <div>
          ...
          <div>
            {passwordReset ? (
              ...
              <p id={Style.resetPasswordText} onClick={setPasswordReset}>
                <img src={password} alt="" /> Reset Rep Password
              </p>
            )}

            {passwordReset ? <Rep_PasswordReset /> : ""}
