...
const Query_Review = () => {
  ...
  return (
    <div id={Style.Query_Review_mainDiv}>
      <Header headerText={"Review"} headerInfo={"let's get rolling"} />
              ...
              <tr>
                ...
                <td>
                  <div id={Style.Query_td}>
                    Lorem ipsum dolor sit amet consectetur. Odio ornare id enim
                    vulputate Lorem ipsum dolor sit amet consectetur. Odio
                    ornare id enim vulputateLorem ipsum dolor sit amet
                    consectetur. Odio ornare id enim vulputate Lorem ipsum dolor
                    sit amet consectetur. Odio ornare id enim vulputateLorem
                    ipsum dolor sit amet consectetur. Odio ornare id enim
                    vulputate Lorem ipsum dolor sit amet consectetur. Odio
                    ornare id enim vulputateLorem ipsum dolor sit amet
                    consectetur. Odio ornare id enim vulputate Lorem ipsum dolor
                    sit amet consectetur. Odio ornare id enim vulputateLorem
                    ...
                    vulputate Lorem ipsum dolor sit amet consectetur. Odio
                    ornare id enim vulputateLorem ipsum dolor sit amet
                    consectetur. Odio ornare id enim vulputate
                  </div>
                </td>
        ...
        <div id={Style.resolution_customerDetails_Div}>
          ...
          <div id={Style.customerDetails_Div}>
            ...
            <div id={Style.img_infoDiv}>
              ...
              <p id={Style.statusDiv}>
                <div id={Style.status}></div>Online
              </p>
            </div>
