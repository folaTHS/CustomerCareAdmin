...
const AddNew_Agent = () => {
  ...
  const handleSubmit = (e) => {
    ...
    let emailVal =
      addStaff.email.includes("@") && addStaff.email.includes(".")
        ? false
        : true;
    ...
    let valid =
      emailVal == false && passwordVal == false && fullNameVal == false;
    ...
    <div id={Style.AddNew_Agent_mainDiv}>
      <div id={Style.AddNew_Agent_wrapperDiv}>
        ...
        <form action="" onSubmit={handleSubmit}>
          <p className={Style.AddNew_Agent_formText}>
            Fill staff detail to continue
          </p>
          ...
          <div>
            ...
            <div>
              ...
              <div id={Style.generatePassword} onClick={generateRandomPassword}>
                Auto Generate Password
              </div>
            </div>

            <div id={Style.AddNew_Agent_buttonDiv}>
